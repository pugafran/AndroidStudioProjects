 ...
 */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener("requestKey") { _, bundle ->
            binding.etiqueta2.text = bundle.getString("bundleKey")
        }

        binding.buttonsito2.setOnClickListener {
            setFragmentResult("requestKey2", bundleOf("bundleKey2" to "Saludos desde el segundo fragmento"))
        }
    }
